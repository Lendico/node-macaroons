...
var Macaroon = function(data) {
  ...
  var _macaroon = {
    ...
    bind: function(sig) {
      ...
      _data._signature = hash.bindForRequest(uint8Sig, _data._signature);
    },
    ...
    verify: function(rootKey, check, discharges) {
      ...
      _macaroon._verify(_data._signature, rootKey, check, dischargesArr, used);
    ...
    _verify: function(rootSig, rootKey, check, discharges, used) {
      ...
      if (!sjcl.bitArray.equal(boundSig, _data._signature)) {
